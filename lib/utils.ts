...
export const serviceColors = {
  yksilo: {
    bg: 'ds:bg-primary-1-dark',
    bgActive: 'ds:active:bg-primary-1-dark-2',
    bgGroupActive: 'ds:group-active:bg-primary-1-dark-2',
    border: 'ds:border-primary-1-dark',
    text: 'ds:text-primary-1-dark',
    textHover: 'ds:hover:text-primary-1-dark',
    textActive: 'ds:active:text-primary-1-dark-2',
    textFocus: 'ds:focus-visible:text-primary-1-dark',
    outline: 'ds:focus-visible:outline-primary-1-dark',
  },
  ohjaaja: {
    bg: 'ds:bg-primary-2-dark',
    bgActive: 'ds:active:bg-primary-2-dark-2',
    bgGroupActive: 'ds:group-active:bg-primary-2-dark-2',
    border: 'ds:border-primary-2-dark',
    text: 'ds:text-primary-2-dark',
    textHover: 'ds:hover:text-primary-2-dark',
    textActive: 'ds:active:text-primary-2-dark-2',
    textFocus: 'ds:focus-visible:text-primary-2-dark',
    outline: 'ds:focus-visible:outline-primary-2-dark',
  },
  palveluportaali: {
    ...
    textHover: 'ds:hover:text-primary-3-dark',
    textActive: 'ds:active:text-primary-3-dark-2',
    textFocus: 'ds:focus-visible:text-primary-3-dark',
    outline: 'ds:focus-visible:outline-secondary-gray',
  },
  tietopalvelu: {
    bg: 'ds:bg-primary-4-dark',
    bgActive: 'ds:active:bg-primary-4-dark-2',
    bgGroupActive: 'ds:group-active:bg-primary-4-dark-2',
    border: 'ds:border-primary-4-dark',
    text: 'ds:text-primary-4-dark',
    textHover: 'ds:hover:text-primary-4-dark',
    textActive: 'ds:active:text-primary-4-dark-2',
    textFocus: 'ds:focus-visible:text-primary-4-dark',
    outline: 'ds:focus-visible:outline-primary-4-dark',
  },
} as const;
