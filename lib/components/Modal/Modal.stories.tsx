  ...
  render: () => {
    ...
    return (
      <>
        ...
        <Modal {...args} setOpen={(value) => setOpen(value)}>
          {(onCloseClick) => (
...
export const ConfirmBeforeClose: Story = {
  render: (args) => {
    ...
    return (
      <>
        <Button label="Open Modal" onClick={() => setOpen(true)} variant="white" />
        <Modal open={open} setOpen={(value) => setOpen(value)} confirmBeforeClose={args.confirmBeforeClose}>
          {(onCloseClick) => (
            <div className="ds:flex ds:flex-col">
              <div className="ds:flex ds:flex-col ds:gap-5 ds:max-w-[1092px] ds:px-6 ds:py-5 ds:sm:px-9">
                <h2 className="ds:text-heading-2">This is a modal dialog!</h2>
            ...
            <div className="ds:flex ds:flex-col">
              <div className="ds:flex ds:flex-col ds:gap-5 ds:max-w-[1092px] ds:px-6 ds:py-5 ds:sm:px-9">
                ...
                <div>
                  ...
                  <Modal open={innerOpen} setOpen={setInnerOpen} confirmBeforeClose={args.confirmBeforeClose}>
                    {(onCloseClick) => (
