...
export const Slider = ({ label, onValueChange, value }: SliderProps) => {
  ...
  return (
    <div className="flex h-[40px] w-full rounded-[20px] bg-white">
      <span className="ml-5 flex items-center justify-center text-[12px]">{label}</span>
      <ArkSlider.Root
        id={inputId}
        name={`slider-${inputId}`}
        className="mx-5 flex grow flex-col justify-center"
      ...
      {focused && (
        <div
          ...
          className="max-w-[292px] rounded-[8px] bg-black px-6 py-3 text-white text-body-md"
