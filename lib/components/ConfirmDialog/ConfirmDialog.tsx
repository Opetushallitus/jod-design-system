            ...
            <div className="ds:flex ds:w-full ds:items-end ds:sm:items-center ds:justify-center ds:h-full">
              ...
              >
                <div className="ds:flex ds:flex-col ds:flex-1 ds:min-h-0 ds:max-w-[640px]">
                  <div className="ds:pt-7 ds:sm:pt-9 ds:px-5 ds:sm:px-9 ds:pb-5">
                    <DialogTitle
                      id={`ds-confirm-dialog-title-${id}`}
                      className="ds:sm:text-[32px] ds:text-[20px] ds:sm:leading-[40px] ds:leading-[26px] ds:font-semibold"
                    >
                      {title}
                    </DialogTitle>
                  </div>
                  <div className="ds:overflow-y-auto ds:flex ds:flex-col ds:px-5 ds:sm:px-9 ds:pb-6 ds:sm:pb-9">
                ...
                <div className="ds:flex-shrink-0 ds:overflow-x-auto ds:overflow-y-hidden ds:bg-bg-gray-2">
