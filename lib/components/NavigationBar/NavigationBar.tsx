...
export const NavigationBar = ({
  ...
  return (
    <div className="ds-min-w-min ds-shadow-border ds-bg-white">
      <nav
        role="navigation"
        className="ds-mx-auto ds-flex ds-h-11 ds-items-center ds-gap-4 ds-px-5 sm:ds-px-7 ds-py-3 ds-font-semibold xl:ds-container"
      >
        ...
        <ul className="ds-inline-flex ds-items-center ds-gap-3 sm:ds-gap-5 ds-ml-auto">
          {menuComponent && <li className="ds-ml-3 sm:ds-ml-0">{menuComponent}</li>}
          {sm && (
            <>
              {languageButtonComponent && (
