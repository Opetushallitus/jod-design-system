...
describe('RangeSlider', () => {
  ...
  it('renders correctly with given markers and value', () => {
    const { getByText, getAllByTestId } = render(
      <RangeSlider markers={markers} value={[0, 100]} onValueChange={onValueChange} dataTestId="slider" />,
    );
  ...
  it('calls onValueChange when slider value changes', async () => {
    ...
    const { getAllByRole } = render(
      <RangeSlider markers={markers} value={[0, 2]} onValueChange={handleChange} dataTestId="slider" />,
    );
  ...
  it('renders disabled state', () => {
    const { container } = render(
      <RangeSlider markers={markers} value={[0, 100]} onValueChange={onValueChange} disabled dataTestId="slider" />,
    );
