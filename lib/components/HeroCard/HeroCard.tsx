...
export const HeroCard = ({
  ...
  if (size === 'sm') {
    return Link && to ? (
      ...
      >
        <div
          className="ds-relative ds-flex ds-flex-row sm:ds-flex-col items-center sm:ds-items-start ds-grow ds-gap-3 sm:ds-gap-6 ds-rounded-lg ds-p-5 sm:ds-p-7 sm:ds-pb-6 ds-tracking-widest ds-justify-between"
          style={{ backgroundColor, color: textColor }}
        >
