...
export const ThreeStateCheckbox: Story = {
  parameters: {
    ...
    docs: {
      description: {
        story:
          'This is a three-state checkbox that cycles between unchecked → indeterminate → checked → unchecked states.',
      },
    },
  },
  args: {
    ...
    ariaLabel: 'Three-state checkbox',
  },
  render: () => {
    ...
    return (
      <div className="ds:flex ds:flex-col ds:gap-4">
        ...
        <Checkbox
          ...
          indeterminate={state === 'indeterminate'}
          onChange={cycleState}
          label="Three-state checkbox with Bordered"
          ariaLabel="Three-state checkbox"
          variant="bordered"
        />
      </div>
...
export const ThreeStateCheckboxWithChildren: Story = {
  parameters: {
    design,
    docs: {
      description: {
